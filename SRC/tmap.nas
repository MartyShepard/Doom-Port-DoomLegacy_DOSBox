;;-----------------------------------------------------------------------------
;;
;; $Id: tmap.nas,v 1.11 2003/06/10 23:36:09 ssntails Exp $
;;
...
; R_DrawSpan is no longer in assembly due to variable flat size support SSNTails 06-10-2003
cglobal R_DrawSpan_8a
R_DrawSpan_8a:
        push    ebp                     ;; preserve caller's stack frame pointer
        push    esi                     ;; preserve register variables
        push    edi
