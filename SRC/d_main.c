...
//
// $Id: d_main.c 1560 2020-11-25 12:34:46Z wesleyjohnson $
//
...
const int  REVISION = 7;   // for bugfix releases, should not affect compatibility. has nothing to do with svn revisions.
